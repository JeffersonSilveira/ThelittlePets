...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    /**
     Este método é validar os campos de texto de entrada e verificar as credenciais de login do SQLite
     */
    private void verifyFromSQLite() {
        ...
        //verificar o usuário existe ou não
        if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim()
            ...
            // Snack Bar para mostrar a mensagem de sucesso que o registro está errado
